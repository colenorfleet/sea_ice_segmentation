...
def spot_correlations(model, metric1, metric2, mode):
    ...
    if mode == 'bar':
        ...
        axs[0].plot([0, 1], [0, 1], color='black', linestyle='--', linewidth=2)
        axs[0].set_ylabel('SIPP Prediction', fontsize=12)
        # axs[0].set_xlabel('SIPP Label', fontsize=12)
        axs[0].set_title('Raw-trained U-Net', fontsize=14)
        ...
        axs[1].plot([0, 1], [0, 1], color='black', linestyle='--', linewidth=2)
        axs[1].set_xlabel('SIPP Label', fontsize=12)
        # axs[1].set_xlabel(metric_dict[metric1], fontsize=12)
        axs[1].set_title('Morph-trained U-Net', fontsize=14)
        ...
        axs[2].plot([0, 1], [0, 1], color='black', linestyle='--', linewidth=2)
        axs[2].set_title('Otsu-trained U-Net', fontsize=14)
